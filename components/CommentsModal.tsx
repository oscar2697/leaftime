...
import { View, Text, KeyboardAvoidingView, Modal, Platform, TouchableOpacity, FlatList, TextInput } from 'react-native'
...
const CommentsModal = ({ postId, visible, onClose }: CommentsProps) => {
